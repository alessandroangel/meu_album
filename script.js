document.addEventListener("DOMContentLoaded", () => {
  ...
  fetch("https://api.github.com/repos/alessandroangel/meu_album/contents/imgs?t=" + Date.now())
    .then(res => {
    ...
    .then(data => {
      ...
      images = data
        ...
        .map(file => `${file.download_url}?v=${file.sha}`);

      console.log("Imagens carregadas:", images.length, images);
      createGallery();
    })
    .catch(err => {
